...
echelon <- function(a, b) {
  ...
  if(a[1, 1] != 1) {
    a[1, 1] <- a[1, 1] / mult_init
    a[1, 2] <- a[1, 2] / mult_init
    a[1, 3] <- a[1, 3] / mult_init
      
    b[1, 1] <- b[1, 1] / mult_init
  }
...
# mat7 <- matrix(c(2, 4, 0, 5, 10, 1, 1, 1, -1), ncol = 3, nrow = 3)
# mat8 <- matrix(c(0, 2, 3), ncol = 1, nrow = 3)
# 
# echelon(mat7, mat8)
